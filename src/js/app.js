...
function generatrePass(){
    ...
    var e = document.getElementById('in_symbol').value
    var n = document.getElementById('in_number').value
    var c = document.getElementById('in_LC').value
    var s = document.getElementById('in_UC').value
    var a = document.getElementById('in_AC').value
